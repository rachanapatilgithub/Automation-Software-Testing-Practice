...
public class ExcelMultipleDataReadTest {
    public static void main(String[] args) throws Exception {
        ...
        FileInputStream fp = new FileInputStream("H:\\Java By Kiran Recording\\Recording\\Selenium Testing\\Recording Selenium Module\\Day22ExelSheetReading\\ExcelSheetMultipleDataRead.xlsx");
