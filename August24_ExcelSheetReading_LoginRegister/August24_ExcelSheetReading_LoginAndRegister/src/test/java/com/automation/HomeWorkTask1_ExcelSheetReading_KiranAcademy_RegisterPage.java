...
public class HomeWorkTask1_ExcelSheetReading_KiranAcademy_RegisterPage {
    public static void main(String[] args) throws Exception {
        ...
        FileInputStream fp = new FileInputStream("H:\\Java By Kiran Recording\\Recording\\Selenium Testing\\Recording Selenium Module\\Day22ExelSheetReading\\HomeWorkTask1_ExcelSheetReading_KiranAcademy_RegisterPage.xlsx");
