package com.automation;
	...
	public class ActionClassTest {
	    ...
	    public static void main(String[] args) {
	        ...
	        act.moveToElement(allcourses).perform();
	        
	        WebElement specialcourse = driver
	                .findElement(By.xpath("/html/body/header/nav/div/div[1]/div/div[1]/div[1]/button[3]"));
	        act.moveToElement(specialcourse).perform();
	        
	        WebElement pythoncourse = driver.findElement(By.xpath("/html/body/header/nav/div/div[1]/div/div[1]/div"));
	        act.moveToElement(pythoncourse).perform();
