...
public class HomeWorkTask_iframeTest2 {
	...
	public static void main(String[] args) {
		...
		// parentFrame() goes back one level only - to the outer frame, not all the way to the main page
		driver.switchTo().parentFrame();

		System.out.println(driver.findElement(By.xpath("/html/body/section/div/div/h5")).getText());

		// defaultContent() goes all the way back to the main page, out of every frame
		driver.switchTo().defaultContent();

		String headtext = driver.findElement(By.xpath("//*[@id=\"header\"]/div/div/div[2]/h1")).getText();
